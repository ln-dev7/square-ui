...
const menuItems: { icon: IconSvgElement; label: string; active?: boolean }[] = [
  { icon: DashboardSquare01Icon, label: "Dashboard" },
  { icon: Notification01Icon, label: "Notification" },
  { icon: UserGroupIcon, label: "Employees", active: true },
  { icon: Calendar03Icon, label: "Attendance" },
  { icon: Coins01Icon, label: "Payroll" },
  { icon: Invoice01Icon, label: "Invoices" },
  { icon: TaskDaily01Icon, label: "Performance" },
];

const favorites: { icon: IconSvgElement; label: string }[] = [
  { icon: Folder01Icon, label: "Reimbursements" },
  { icon: Folder01Icon, label: "Timesheets" },
  { icon: Folder01Icon, label: "Overtime Logs" },
];

const footerItems: { icon: IconSvgElement; label: string }[] = [
  ...
  return (
    <Sidebar className="lg:border-r-0!" collapsible="offcanvas" {...props}>
      <SidebarHeader className="pb-0">
        <div className="px-2 py-3">
          ...
          <div className="mt-4 relative">
            <HugeiconsIcon
              icon={Search01Icon}
              className="absolute left-2.5 top-1/2 size-4 -translate-y-1/2 text-muted-foreground z-10"
            />
            <Input
              type="search"
      ...
      <SidebarFooter className="p-4">
        ...
        <div className="mt-4">
          <Link
            href="https://github.com/ln-dev7/square-ui/tree/master/templates-baseui/employees"
            target="_blank"
