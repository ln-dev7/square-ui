      ...
      <div className="flex flex-col sm:flex-row sm:items-center gap-3 sm:gap-4 p-3 sm:px-6 sm:py-3.5">
        <div className="flex items-center gap-2 sm:gap-2.5 flex-1">
          <Button variant="outline" size="icon" className="size-7 sm:size-8 shrink-0">
            <HugeiconsIcon
              ...
              className="size-4 sm:size-[18px] text-muted-foreground"
            />
          </Button>
        ...
        <div className="flex flex-wrap items-center gap-2">
          <div className="relative flex-1 sm:flex-none">
            <HugeiconsIcon
              icon={Search01Icon}
              className="absolute left-3 top-1/2 -translate-y-1/2 size-4 sm:size-5 text-muted-foreground"
            />
            <Input
              placeholder="Search..."
              value={searchQuery}
          ...
          <DropdownMenu>
            <DropdownMenuTrigger
              render={
                ...
                >
                  <HugeiconsIcon icon={FilterIcon} className="size-3.5 sm:size-4" />
          ...
          <DropdownMenu>
            <DropdownMenuTrigger
              render={
                <Button variant="outline" size="sm" className="h-8 sm:h-9 gap-1.5 sm:gap-2">
                  <HugeiconsIcon icon={FileImportIcon} className="size-3.5 sm:size-4" />
            ...
            <DropdownMenuContent align="end">
              <DropdownMenuItem>
                <HugeiconsIcon icon={Csv02Icon} className="size-4 mr-2" />
                Import from CSV
              </DropdownMenuItem>
              <DropdownMenuItem>
