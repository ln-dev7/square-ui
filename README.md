...
| --------------------- | ---------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------- | -------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------- | ---------------------------------------- |
| **Finance Tracker** | Personal finance dashboard with income vs expenses area chart, spending categories, budget overview, and transactions table. | [View Demo](https://square-ui-finance-tracker.vercel.app) | [Square UI Pro](https://pro.lndev.me/templates) | | [LN](https://x.com/ln_dev7) |
